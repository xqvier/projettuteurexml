...
<body>
 <ul>
	<form action="index.php" method="get">
		<a href="index.php?page=genres"><li><strong>Genres </strong>| </li></a>
		<a href="index.php?page=films"><li><strong>Films </strong>| </li></a>
		<a href="index.php?page=ajouter"><li><strong>Ajouter un film</strong></li></a>
